...
## Local permission grants pruned; they will grow back (2026-09-26) — DONE, P1

**Component:** `.claude/settings.local.json` (gitignored, untracked)
...
**No backup was taken. The prune cannot be undone.** Only `permissions.allow` changed; the
